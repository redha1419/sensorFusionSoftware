...
CREATE TABLE sensor_fusion.sensors ( 
	...
	CONSTRAINT fk_sensors_projects FOREIGN KEY ( project_id ) REFERENCES sensor_fusion.projects( project_id )  
 );
...
CREATE TABLE sensor_fusion.frames ( 
	...
	CONSTRAINT fk_frames_sensors FOREIGN KEY ( sensor_id ) REFERENCES sensor_fusion.sensors( sensor_id )  
 );
...
CREATE TABLE sensor_fusion.bounding_boxes ( 
	...
	CONSTRAINT fk_bounding_boxes_frames FOREIGN KEY ( frame_id ) REFERENCES sensor_fusion.frames( frame_id )  
 );
